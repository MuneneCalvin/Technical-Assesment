...
# Get the dataset by availability
$ GET 'http://localhost:3000/properties?availability=boolean'

# Get the dataset by price range
$ GET 'http://localhost:3000/properties?minPrice=number&maxPrice=number'
```
